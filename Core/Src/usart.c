...
void HAL_UART_MspInit(UART_HandleTypeDef* uartHandle)
{
  ...
  */
    ...
    */
    ...
    handle_GPDMA2_Channel5.Init.TransferAllocatedPort = DMA_SRC_ALLOCATED_PORT1|DMA_DEST_ALLOCATED_PORT0;
    ...
    __HAL_LINKDMA(uartHandle, hdmatx, handle_GPDMA2_Channel5);
