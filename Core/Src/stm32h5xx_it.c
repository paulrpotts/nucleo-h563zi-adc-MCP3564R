...
void NMI_Handler(void)
{
  ...
  /*
   * Handle double ECC errors when reading uninitialized flash; this is a
   * normal condition when reading an uninitialized flash page into a memory
   * block in SRAM before updating and rewriting it.
   */
  if (FLASH->ECCDETR & FLASH_ECCR_ECCD)
  {
    ...
    /*
     * Clear the ECC double error flag
     */
